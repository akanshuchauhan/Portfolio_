...
import { logo, logo2, logo4 } from "../../assets/index";

const Footer = () => {
  return (
    <div className="w-full px-16 py-8 h-auto border-b-[1px] border-b-black grid grid-cols-1 md:grid-cols-2 lgl:grid-cols-4 gap-8">
